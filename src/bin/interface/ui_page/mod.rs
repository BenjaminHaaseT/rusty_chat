        ...
        W: WriteExt + Unpin,
    {
        ...
        match self {
            ...
            UIPage::UsernamePage => {
                ...
                // Ok(())
                UIPage::username_process_request_helper(out, to_server).await
            }
            ...
            UIPage::LobbyPage {username, lobby_state} => {
                ...
                // Ok(())
                UIPage::lobby_process_request_helper(username, lobby_state, out, to_server).await
            }
            ...
            UIPage::Chatroom {username, chatroom_name} => {
                ...
                // Ok(())
                UIPage::chatroom_process_request_helper(username, chatroom_name, out, to_server, from_server).await
            }
            ...
            UIPage::QuitChatroom {username, chatroom_name} => {
                ...
                //     .map_err(|_| UserError::InternalServerError("an internal server error occurred"))?;
                // Ok(())
                UIPage::quit_chatroom_process_request_helper(to_server).await
            }
            _ => unreachable!()
        }
    }
